class SleepingPillow{
    ...
    public static void main(String[] hallowFiber){
	...
	public static void getFeatures(){
		...
		System.out.println("The Type of Pillow is " + typeOfPillow);
		System.out.println("The Special Pattern is " + specialFeature);
